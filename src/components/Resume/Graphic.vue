...
<script setup>
import { defineProps, toRefs, ref, computed, watch, defineEmits } from "vue"; //defineEmits
...
const points = computed(() => {
  ...
  return amounts.value.reduce((points, amount, indice) => {
    const x = (300 / total) * (indice + 1);
